...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1179468118' '8170914911').split()] # Replace with the actual admin ID(s) to add
